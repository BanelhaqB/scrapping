...
const runThroughPage = async (page, data) => {
  ...
  for await (const conv of conversations.Conversations) {
    ...
    fetch(`https://www.tusclases.com/api_common/api/messages/gdlg?ucid=${compte.id}&upt=${compte.upt}&gid=${conv.Id}&l=fr&tzo=-120&tcpcid=0&ch=1134F8CB0AB42FFDD2B88B0A1DB0C04CF893F6B9DF6F77D2AE658D0BCEC0DE653A66F188650DAA042E24997E764EFDEAE69C0AB06971A4DF66F8FEE4D59FF668`, {
      "credentials": "omit",
      "headers": {
